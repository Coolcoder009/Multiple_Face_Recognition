...
while True:
    ...
    for(x,y,w,h) in faces:
        ...
        if Id == 1:
            Id = "Abdul {0:.2f}%".format(round(100 - confidence, 2))
            # Put text describe who is in the picture
        elif Id == 2 :
            Id = "DG {0:.2f}%".format(round(100 - confidence, 2))
            # Put text describe who is in the picture
        elif Id == 4:
            Id = "Ajit {0:.2f}%".format(round(100 - confidence, 2))
        elif Id == 5:
            Id = "Gokul {0:.2f}%".format(round(100 - confidence, 2))
        elif Id == 6:
            Id = "Brinyl {0:.2f}%".format(round(100 - confidence, 2))
        elif Id == 7:
            Id = "Jafar {0:.2f}%".format(round(100 - confidence, 2))
        elif Id == 3:
            Id = "Sridhar {0:.2f}%".format(round(100 - confidence, 2))
        else:
            Id = "Unknown"
